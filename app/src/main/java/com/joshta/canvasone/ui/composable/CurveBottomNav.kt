...
private const val CURVE_CIRCLE_RADIUS = 20F
private const val CURVE_CIRCLE_RADIUS_W = 96F
    ...
    override fun createOutline(
        ...
        return Outline.Generic(path = Path().apply {
            ...
            mFirstCurveStartPoint.set(
                (size.width / 2) - (CURVE_CIRCLE_RADIUS_W * 2) - (CURVE_CIRCLE_RADIUS_W / 3),
                curveDepth
            )
            ...
            mFirstCurveControlPoint2.set(
                mFirstCurveEndPoint.x - (CURVE_CIRCLE_RADIUS_W * 2) + CURVE_CIRCLE_RADIUS_W,
                mFirstCurveEndPoint.y
            )
            mSecondCurveControlPoint1.set(
                mSecondCurveStartPoint.x + (CURVE_CIRCLE_RADIUS_W * 2) - CURVE_CIRCLE_RADIUS_W,
